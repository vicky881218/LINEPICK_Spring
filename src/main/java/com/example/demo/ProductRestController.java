...
public class ProductRestController {
   ...
   public Type retrieveProductType(@PathVariable("id") int id) throws SQLException {
      System.out.println("in /ProductType/{id} spring");
      System.out.println("product_id:" + id);
      ProductType FindType = productTypeDAO.findProuductTypeByProduct(id);
      int type_id = FindType.getTypeId();
      Type type = typeDAO.findOne(type_id);
      return type;
   }
   ...
   public void retrieveProductEditUpdate(@RequestBody Product product) throws SQLException {
   ...
   @GetMapping(value = { "/productTypeIdByName/{product_name}" })
   public List<ProductType> retrieveproductTypeIdByName(@PathVariable("product_name") String product_name) throws SQLException {
      System.out.println("in /productTypeIdByName/{product_name} spring");
      System.out.println(" product_name:" +  product_name);
      List<ProductType> All = productTypeDAO.findProductTypeIdByName(product_name);
      return All;
   }
 
   // 更改商品的商品分類
   @PutMapping(value = "/ProductTypeEdit")
   public void retrieveProductTypeEditUpdate(@RequestBody ProductType productType) throws SQLException {
      System.out.println("in ProductTypeEdit spring");
      System.out.println("type_id:" + productType.getTypeId());
      System.out.println("product_type_id:" + productType.getProductTypeId());
   ...
   // 刪除Product
   @DeleteMapping(value = "/ProductDelete/{product_name}")
   public void retrieveProductDelete(@PathVariable("product_name") String product_name) throws SQLException {
      System.out.println("in ProductDelete spring");
      System.out.println("product_name:" + product_name);
   ...
   // 新增商品(react native)
   @PostMapping(value = "/ProductAddPost")
   public int retrieveProductAddPut(@RequestBody Product product) throws SQLException {
      System.out.println("in ProductAddPost spring");
      System.out.println("product:" + product);
      int result = productDAO.insertToType(product);
      System.out.println("產生key");
      System.out.println(result);
   ...
   // 新增商品完商品去produtc_type新增(react native)
   @PostMapping(value = "/ProductTypeAddPost")
   public int retrieveProductTypeAddPost(@RequestBody ProductType productType) throws SQLException {
      System.out.println("in ProductTypeAddPost spring");
      return productTypeDAO.insert(productType);
   }
